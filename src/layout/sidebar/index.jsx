...
export default function Sidebar() {
  return (
    <div className="fixed right-0 h-screen w-64 shadow-lg flex flex-col justify-between">
        {/*topp Content*/}
        <div className="flex justify-between items-center h-16 shadow-md p-2 bg-blue-600 dark:bg-gray-900 rounded-t-lg">
          <div>
        ...
        {/* Bottom Content */}
        <div className="flex flex-col gap-4 flex-1 bg-blue-400 dark:bg-gray-900 rounded-b-lg">
